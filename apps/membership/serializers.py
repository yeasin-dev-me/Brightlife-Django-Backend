...
from .models import MembershipApplication, Nominee, MedicalRecord, ApplicationStatusHistory
...
class NomineeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Nominee
        fields = ['name', 'relationship', 'relation', 'share', 'age', 'photo', 'id_proof']
        extra_kwargs = {
...
class MembershipApplicationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            # Proposal info
            'proposal_no', 'fo_code', 'fo_name',
            # Personal info
            'membership_type', 'gender', 'name_bangla', 'name_english',
            'father_name', 'mother_name', 'spouse_name',
            'mobile', 'email', 'photo', 'dob', 'age',
            'nationality', 'age_proof', 'age_proof_doc',
            'driving_license', 'license_doc', 'marital_status',
            'education', 'professional_qualifications',
            'occupation', 'organization_details', 'daily_work',
            ...
            'weight', 'height', 'blood_group', 'chest',
            'surgery_details', 'medical_records',
            # Terms
            'accept_terms',
            # Meta
...
class MembershipApplicationListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MembershipApplication
        fields = [
            'id', 'proposal_no', 'name_english', 'membership_type',
