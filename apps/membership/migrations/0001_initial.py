    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "permanent_address",
                    models.TextField(help_text="Full permanent address"),
                ),
                (
                    "weight",
                    models.DecimalField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-created_at"], name="membership__created_80e201_idx"
                    ),
                    models.Index(
                        fields=["status"], name="membership__status_fddb44_idx"
                    ),
                    models.Index(
                        fields=["proposal_number"],
                        name="membership__proposa_62196f_idx",
                    ),
                    models.Index(
                        fields=["nid_number"], name="membership__nid_num_cecdc1_idx"
                    ),
                ],
            },
        ),
