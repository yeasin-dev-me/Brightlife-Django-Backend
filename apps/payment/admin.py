...
class PaymentProofAdmin(admin.ModelAdmin):
    ...
    list_filter = ["status", "payment_method", "submitted_at", "verified_at"]

    search_fields = ["transaction_id", "payer_name", "payer_contact"]
    ...
    fieldsets = (
        ...
        ("Proof & Notes", {"fields": ("screenshot", "screenshot_preview", "notes")}),
        (
            "Verification",
        ...
        (
            "Association",
            {"fields": ("membership_application",), "classes": ("collapse",)},
        ),
        (
            "Metadata",
            {
