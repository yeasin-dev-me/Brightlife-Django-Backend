...
class PaymentProof(models.Model):
    ...
    transaction_id = models.CharField(
        max_length=100, unique=True, help_text="Transaction/Reference ID from payment"
    )
    payment_method = models.CharField(
        max_length=20, choices=PAYMENT_METHOD_CHOICES, help_text="Payment method used"
    )
    ...
    payer_name = models.CharField(
        max_length=200, help_text="Name of person who made payment"
    )
    payer_contact = models.CharField(max_length=50, help_text="Contact number of payer")
    ...
    notes = models.TextField(
        max_length=500, blank=True, help_text="Additional notes or comments"
    )
    ...
    verified_at = models.DateTimeField(
        null=True, blank=True, help_text="Timestamp when payment was verified"
    )
    ...
    ip_address = models.GenericIPAddressField(
        null=True, blank=True, help_text="IP address of submitter"
    )
